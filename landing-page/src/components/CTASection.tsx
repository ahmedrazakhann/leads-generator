      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-10">
            <button 
              onClick={openModal}
              className="px-10 py-5 text-xl font-black text-white bg-linear-to-r from-teal-500 to-blue-600 rounded-full hover:shadow-[0_0_40px_rgba(20,184,166,0.5)] hover:scale-105 transition-all flex items-center gap-3 shadow-2xl"
            >
